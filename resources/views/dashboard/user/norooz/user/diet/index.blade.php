            ...
            <div class="row layout-spacing">
                <div class="col-lg-12">
                    ...
                    <div class="widget-content widget-content-area">
                        ...
                        <div class="row">
{{--                            <button class="btn btn-secondary mb-4 mr-2 w-50">دکمه پیش فرض</button>--}}
{{--                            <button class="btn btn-secondary mb-4 mr-2 w-50">دکمه پیش فرض</button>--}}
{{----}}
                            <div class="container">
                                <div class="box">
                                    ...
                                    <div class="content">
                                        ...
                                        <p>
                                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Cupiditate temporibus quae aut ipsum ratione ipsa quas quis quo quaerat libero modi omnis eum vero, excepturi, sit maiores dolorem consequatur iste?
                                        </p>
                                        <a href="{{route('norooz-diet-week-one')}}">
                                            ورود
                                        </a>
                                    </div>
                                </div>
                                <div class="box">
                                    ...
                                    <div class="content">
                                        ...
                                        <a href="{{route('norooz-diet-week-two')}}">
                                            ورود
                                        </a>
                                    </div>
                                </div>
