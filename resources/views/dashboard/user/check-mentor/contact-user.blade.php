        ...
        <div class="layout-px-spacing">
            ...
            <nav class="breadcrumb-two" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="{{url('dashboard/contact-user')}}">  انتخاب داوطلب برای ثبت تماس با اولیا و داوطلب</a>
            ...
            <div class="page-header">
                <div class="page-title">
                    <h5>انتخاب داوطلب برای ثبت تماس با اولیا و داوطلب</h5>
                </div>
            </div>
                                ...
                                <div class="col-sm-12">
                                    <table id="default-ordering" class="table table-hover dataTable" role="grid"
                                        ...
                                        <tr role="row">
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="default-ordering"
                                                rowspan="1" colspan="1"
                                                aria-label=" اولیا : activate to sort column ascending"> اولیا
                                            </th>

                                            <th class="sorting" tabindex="0" aria-controls="default-ordering"
                                                rowspan="1" colspan="1"
                                                aria-label=" داوطلب : activate to sort column ascending"> داوطلب
                                            </th>
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="default-ordering"
                                                rowspan="1" colspan="1"
                                                aria-label="عمل: activate to sort column ascending">عمل
                                            </th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        ...
                                        <tr role="row">
                                            ...
                                            <td class="text-center">
                                                <input  id="datepicker0">



                                                <a style="color: #0d9a5d" data-toggle="modal"data-target="#exampleModalCenter">مشاهده</a>
                                        ...
                                        <tr>
                                            ...
                                            <th style="color: #004fe6" rowspan="1" colspan="1"> اولیا</th>
                                            <th style="color: #004fe6" rowspan="1" colspan="1"> داوطلب</th>
                                            <th style="color: #004fe6" rowspan="1" colspan="1"> عمل</th>
