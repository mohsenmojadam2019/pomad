                            ...
                            <div class="widget-content widget-content-area">
                                ...
                                <div class="form-row">
                                    <div class="col-md-6 mb-4">
                                        ...
                                        <span  style="color: #6f42c1">{{$user_address ? $user_address->province : ''}}</span>


                                    </div>
                                    <div class="col-md-6 mb-4">
                                        <label for="validationCustom01">شهرستان</label>
                                        <span  style="color: #6f42c1">{{ $user_address ?  $user_address->city : ''}}</span>
                                    </div>
                                ...
                                <div class="form-row">
                                    <div class="col-md-6 mb-4">
                                        ...
                                        <span  style="color: #6f42c1"> {{$user_address ? $user_address->address: ''}}</span>
                                    </div>
                                ...
                                <div class="form-row">
                                    <div class="col-md-6 mb-4">
                                        <label for="validationCustom03">کد پستی </label>
                                          <span  style="color: #6f42c1"> {{$user_address ? $user_address->postal_code: ''}}</span>
                                    </div>
