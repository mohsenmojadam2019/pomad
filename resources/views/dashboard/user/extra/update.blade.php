                    ...
                    <div class="scrollspy-example" data-spy="scroll" data-target="#account-settings-scroll"
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
                                <form action="{{route('edit-profile-infos.update')}}" method="post" id="general-info" class="section general-info">
                                    @csrf
                                    @method('put')
                                    <div class="info">
                                        ...
                                        <div class="text-center mt-3">
                                            <a  type="submit" class="btn btn-primary text-center">ثبت</a>
                                    </div>
