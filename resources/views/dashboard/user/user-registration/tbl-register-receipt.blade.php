        ...
        <div class="layout-px-spacing">
            ...
            <nav class="breadcrumb-two" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="{{url('dashboard/educational-group')}}">ثبت فیش</a>
                    </li>
                </ol>
            </nav>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <table id="default-ordering" class="table table-hover dataTable" role="grid"
                                        ...
                                        {{--تعداد--}}
                                        <div style="margin: 20px">تعداد  نفر</div>
...
{{--                                                &nbsp--}}
{{--                                                &nbsp--}}
                                                <a href="" style="color: red">ثبت فیش</a></td>
                                        </tr>
