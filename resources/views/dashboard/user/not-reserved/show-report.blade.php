...
<div id="content" class="main-content">
    <nav class="breadcrumb-two" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="{{url('dashboard/educational-group')}}">انتخاب داوطلب برای مشاهده کارنامه</a></li>
        </ol>
    </nav>
    ...
    <div class="layout-px-spacing">
        ...
        <div class="page-header">
            <div class="page-title">
                <h3>انتخاب داوطلب برای مشاهده کارنامه</h3>
            </div>
        </div>
            ...
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <div class="widget-content widget-content-area br-6">
                    ...
                    <div class="form-group custom-select-sm">
                       <lable>مشاوره همراه :</lable>
                        <select class="form-control custom-select" name="" id="">

                            <option value="all">انتخاب مشاوره همراه</option>
                    ...
                    <div style="margin-top:50px">   تعداد: <span style="color: red">  112 نفر</span></div>
