        ...
        <div class="layout-px-spacing">
            ...
            <nav class="breadcrumb-two" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="{{url('dashboard/contact-user')}}"> بارگذاری برنامه غیر حضوری ها</a>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <table id="default-ordering" class="table table-hover dataTable" role="grid"
                                        ...
                                        {{--تعداد--}}
                                        <div style="margin: 20px"> <span style="color: red"></span>تعداد</div>
                                        ...
                                        <tr role="row">
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a style="color: #0d9a5d;float: right" data-toggle="modal"data-target="#exampleModalCenter">مشاهده</a>


                                                <a href="{{url('dashboard/upload-app')}}" style="color: red;float: left">ارسال برنامه</a>
                                            </td>
                                        </tr>
