                    ...
                    <div id="custom_styles" class="col-lg-12 layout-spacing col-md-12">
                        <div class="statbox widget box box-shadow">
                            ...
                            <div class="widget-content widget-content-area">
                                <form method="post" action="{{route('educational-field.update',$educational_field->id)}}"  class="needs-validation was-validated" novalidate="">
                                    @csrf
                                    @method('put')
                                    <div class="form-row">
                                        <div class="col-md-6 mb-4">
                                            ...
                                            <button  class="btn btn-secondary mt-2">آپدیت</button>
