    ...
    <div id="content" class="main-content">
        ...
        <nav class="breadcrumb-two" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="{{url('dashboard/user-info')}}">اطلاعات مدرسه</a></li>
                <li class="breadcrumb-item active"><a href="{{url('dashboard/user-info/create')}}">اضافه کردن اطلاعات
                        مدرسه</a></li>
                    ...
                    <div id="custom_styles" class="col-lg-12 layout-spacing col-md-12">
                        <div class="statbox widget box box-shadow">
                            ...
                            <div class="widget-content widget-content-area">
                                <form action="{{route('user-info.update',$user_info->id)}}" method="POST"
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-6 mb-4">
                                            ...
                                            <div class="col-md-6 mb-4">
                                                <div class="input-group">
                                                    <label for="validationCustomUsername">جنسیت</label>
                                                    <div id="select_menu" class="form-group ">
                                                        <select class="custom-select" required name="gender">
                                                            <option value="{{$user_info->id}}">{{$user_info ? ($user_info->gender == 'female' ? 'خانوم' : 'آقا') : '' }}</option>

                                                        </select>
                                                        <div class="valid-feedback">به عنوان مثال بازخورد سفارشی معتبر
                                                            را انتخاب
                                                            کنید
                                                        </div>
                                                        <div class="invalid-feedback">
